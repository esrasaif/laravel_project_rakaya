    ...
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            @auth
             ...
             <form action="/logOut" method="POST" class="text-xs font-bold uppercase">
                    @csrf
                    <button type="submit"  class="bg-blue-900 ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">Log Out</button>
             </form>
