                ...
                @auth
                    ...
                    <x-panel class="bg-gray-50 ">
                            ...
                            @csrf
                                ...
                                <div>
                                        <textarea name="body" id="body" cols="10" rows="10" class="mt-4 w-full text-sm border-none bg-gray-100 focus:outline-none rounded-xl " placeholder = "your comment important " >
                                        </textarea>               
                                </div>
